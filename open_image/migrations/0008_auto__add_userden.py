...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserDen'
        db.create_table('open_image_userden', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 19, 0, 0))),
        ))
        db.send_create_signal('open_image', ['UserDen'])


    def backwards(self, orm):
        # Deleting model 'UserDen'
        db.delete_table('open_image_userden')
