...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field dens on 'Article'
        db.create_table('open_image_article_dens', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['open_image.article'], null=False)),
            ('den', models.ForeignKey(orm['open_image.den'], null=False))
        ))
        db.create_unique('open_image_article_dens', ['article_id', 'den_id'])


    def backwards(self, orm):
        # Removing M2M table for field dens on 'Article'
        db.delete_table('open_image_article_dens')
    ...
    models = {
        ...
        'open_image.article': {
            ...
            'dens': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['open_image.Den']", 'symmetrical': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'news_website': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['open_image.NewsWebsite']"}),
        ...
        'open_image.den': {
            'Meta': {'object_name': 'Den'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'open_image.newswebsite': {
