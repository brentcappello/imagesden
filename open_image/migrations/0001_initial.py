...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('open_image_newswebsite', (
        ...
        db.send_create_signal('open_image', ['NewsWebsite'])

        # Adding model 'Article'
        db.create_table('open_image_article', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('news_website', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['open_image.NewsWebsite'])),
        ...
        db.send_create_signal('open_image', ['Article'])


    def backwards(self, orm):
        # Deleting model 'NewsWebsite'
        db.delete_table('open_image_newswebsite')

        # Deleting model 'Article'
        db.delete_table('open_image_article')
