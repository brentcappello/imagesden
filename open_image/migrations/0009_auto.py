...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field userdens on 'Article'
        db.create_table('open_image_article_userdens', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['open_image.article'], null=False)),
            ('userden', models.ForeignKey(orm['open_image.userden'], null=False))
        ))
        db.create_unique('open_image_article_userdens', ['article_id', 'userden_id'])


    def backwards(self, orm):
        # Removing M2M table for field userdens on 'Article'
        db.delete_table('open_image_article_userdens')
    ...
    models = {
        ...
        'open_image.article': {
            ...
            'userdens': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['open_image.UserDen']", 'symmetrical': 'False'})
        },
        'open_image.den': {
