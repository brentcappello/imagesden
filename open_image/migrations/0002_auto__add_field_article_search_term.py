...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.search_term'
        db.add_column('open_image_article', 'search_term',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.search_term'
        db.delete_column('open_image_article', 'search_term')
