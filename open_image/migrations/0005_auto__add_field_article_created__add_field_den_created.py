...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('open_image_article', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 25, 0, 0)),
                      keep_default=False)

        # Adding field 'Den.created'
        db.add_column('open_image_den', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 25, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('open_image_article', 'created')

        # Deleting field 'Den.created'
        db.delete_column('open_image_den', 'created')
    ...
    models = {
        ...
        'open_image.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)'}),
